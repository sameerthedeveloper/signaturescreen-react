  ...
  return (
    <div className={`h-screen w-full overflow-hidden fixed inset-0 dark:bg-gray-900 dark:text-white lg:pb-0 ${themeClasses.bg}`}>
      ...
      <div className={`flex flex-col lg:flex-row lg:gap-8 lg:justify-center lg:items-start p-4 lg:p-8 pt-20 lg:pt-24 lg:h-full`}>
         ...
         <div className={`home w-full lg:w-[450px] shrink-0 h-[calc(100vh-150px)] lg:h-[calc(100vh-120px)] overflow-y-auto pr-2 pb-24 lg:pb-0 scrollbar-hide ${activeTab === 'home' ? 'block' : 'hidden lg:block'}`}>
         ...
         <div className={`quta w-full lg:flex-1 lg:max-w-[800px] lg:h-[calc(100vh-120px)] h-[calc(100vh-150px)] overflow-y-auto pr-2 pb-24 lg:pb-0 scrollbar-hide ${activeTab === 'invoice' ? 'block' : 'hidden lg:block'}`}>
