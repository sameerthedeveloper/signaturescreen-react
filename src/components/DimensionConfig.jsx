...
const DimensionConfig = ({ hPanels, setHPanels, vPanels, setVPanels, totalPanels, dimensions }) => {
  return (
    <div className="flex flex-col mb-4 bg-white p-6 gap-4 rounded-2xl shadow-sm border border-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:text-white">
      ...
      <h2 className="text-sm font-semibold text-gray-500">Dimensions (ft)</h2>
      <div className="grid grid-cols-2 gap-4">
        <div className="flex flex-col">
            <span className="text-xs text-gray-400">Width</span>
            <div className="bg-gray-50 border border-gray-200 p-2 rounded text-sm text-center font-medium dark:bg-gray-700 dark:border-gray-600">{dimensions.widthFt}</div>
        </div>
        <div className="flex flex-col">
            <span className="text-xs text-gray-400">Height</span>
            <div className="bg-gray-50 border border-gray-200 p-2 rounded text-sm text-center font-medium dark:bg-gray-700 dark:border-gray-600">{dimensions.heightFt}</div>
        </div>
      </div>
